...
from torchreid_uncertain.engine.image import ImageSoftmaxEngine
...
class VideoSoftmaxEngine(ImageSoftmaxEngine):
    ...
    Args:
        datamanager (DataManager): an instance of ``torchreid_uncertain.data.ImageDataManager``
            or ``torchreid_uncertain.data.VideoDataManager``.
    ...
    Examples::
        ...
        datamanager = torchreid_uncertain.data.VideoDataManager(
